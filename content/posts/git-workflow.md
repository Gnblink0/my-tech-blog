...
| Workflow Name                         | Main Branch Strategy                             | Key Features                                                                        | Suitable Scenarios                                                   |
| ------------------------------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| Centralized Workflow                  | Only main                                        | All development directly on main branch, similar to SVN                             | Small teams or personal projects, suitable for Git beginners         |
| Feature Branch Workflow (GitHub Flow) | main + feature branches                          | One branch per feature, requires Pull Request for merging                           | Multi-person collaboration, CI/CD, modern web projects               |
| Git Flow                              | main + develop + feature/hotfix/release branches | Multiple branches, clear rules, suitable for projects with clear version iterations | Traditional software development with clear release cycles           |
| Trunk-Based Development               | Only main (or trunk)                             | Direct development on main branch, frequent merging, requires feature toggle        | Large agile teams pursuing continuous deployment and rapid iteration |
